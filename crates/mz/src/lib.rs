//! The MZ virtual data source.
//!
//! MZ turns a URI plus backend configuration into an OpenDAL [`Operator`],
//! so everything above never has to know whether the bytes come from a local
//! file, S3, SFTP or HTTP.
